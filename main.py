...
class Account:
    """Represents an individual bank account held within the ATM system."""

    def __init__(
        self, card_number: str, pin: str, name: str, balance: float = 0.0
    ):
    ...
    def change_pin(self, new_pin: str) -> tuple[bool, str]:
...
class ATMSimulator:
    """Handles ATM interface, user sessions, and database simulation."""

    def __init__(self):
        # Sample bank account database
        self.accounts = {
            "1001": Account(
    ...
    def authenticate_user(self) -> bool:
        ...
        print("\nAccount locked due to 3 failed PIN attempts.")
        return False
